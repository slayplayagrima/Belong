    ...
    <footer className="bg-muted/50 pt-20 pb-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          {/* Column 1: Brand */}
          <div>
            <Link to="/" className="flex items-center gap-2 text-primary font-serif text-2xl tracking-tight mb-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/animals" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                  Browse Animals
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/my-requests" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                  My Requests
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/ngo/register" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                  Register NGO
                </Link>
              </li>
              <li>
                <Link to="/ngo/dashboard" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                  NGO Dashboard
                </Link>
              </li>
              <li>
                <Link to="/ngo/add-animal" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                  Add an Animal
                </Link>
              </li>
            </ul>
